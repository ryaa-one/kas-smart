...
export default function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      window.location.href = logged.role === "Kasir" ? "/kasir/dashboard" : "/dashboard";
    }, 400);
  };
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Panel — Branding */}
      <div className="hidden lg:flex flex-col w-1/2 bg-primary p-12 relative overflow-hidden">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-3.5 py-2.5 rounded-lg border bg-white text-sm text-foreground
