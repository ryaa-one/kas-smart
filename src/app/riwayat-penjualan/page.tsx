...
import { mockSales, type Sale, type SaleStatus } from "@/lib/mock/owner";
...
export default function RiwayatPenjualanPage() {
  ...
  // PRD FR-12: riwayat dilihat kembali berdasarkan nomor invoice atau tanggal.
  ...
  return (
    <DashboardLayout title={t.riwayat.title} subtitle={t.riwayat.subtitle}>
      <Card>
        ...
        <div className="flex flex-col lg:flex-row lg:items-center gap-2 mb-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <select value={status} onChange={(e) => setStatus(e.target.value as StatusFilter)} className={inputCls}>
              ...
              <option value="draft">{t.riwayat.statusDraft}</option>
        ...
        <Table
          empty={mockSales.length === 0 ? t.riwayat.empty : t.riwayat.emptySearch}
          head={
            <>
